...
The code of the project is based on the legendary **[ggml.cpp](https://github.com/ggserganov/llama.cpp)** framework of Georgi Gerganov written in C++ with the same attitude to performance and elegance.
